...
void SDL_Clay_RenderFillRoundedRect(Clay_SDL3RendererData* rendererData, const SDL_FRect rect, const float cornerRadius, const Clay_Color _color)
{
    ...
    const float step = (SDL_PI_F / 2) / (float)numCircleSegments;
...
{
    SDL_SetRenderDrawColor(rendererData->renderer, (uint8_t)color.r, (uint8_t)color.g, (uint8_t)color.b, (uint8_t)color.a);
...
void SDL_Clay_RenderClayCommands(Clay_SDL3RendererData* rendererData, Clay_RenderCommandArray* rcommands)
{
    ...
    {
        const Clay_RenderCommand* rcmd = Clay_RenderCommandArray_Get(rcommands, (int32_t)i);
            ...
            case CLAY_RENDER_COMMAND_TYPE_RECTANGLE:
                {
                    ...
                    SDL_SetRenderDrawColor(rendererData->renderer, (uint8_t)config->backgroundColor.r, (uint8_t)config->backgroundColor.g, (uint8_t)config->backgroundColor.b, (uint8_t)config->backgroundColor.a);
            ...
            case CLAY_RENDER_COMMAND_TYPE_TEXT:
                {
                    ...
                    TTF_SetTextColor(text, (uint8_t)config->textColor.r, (uint8_t)config->textColor.g, (uint8_t)config->textColor.b, (uint8_t)config->textColor.a);
            ...
            case CLAY_RENDER_COMMAND_TYPE_BORDER:
                {
                    ...
                    //edges
                    SDL_SetRenderDrawColor(rendererData->renderer, (uint8_t)config->color.r, (uint8_t)config->color.g, (uint8_t)config->color.b, (uint8_t)config->color.a);
